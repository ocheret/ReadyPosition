...
package com.readyposition.collections.hash.test;
...
import com.readyposition.collections.comparator.Comparators;
...
public class HashMapGTest {
    /** The hash map we will be testing. */
    protected MapG<_KeyType_, _ValueType_> m_map;

    protected final static int TEST_SIZE = Types.testSizeLong();

    @Before
    public void setUp() {
        m_map = new HashMapG<_KeyType_, _ValueType_>();
    }
    ...
    protected void assertValueEquals(String message, _ValueType_ expected, _ValueType_ actual) {
    ...
    protected void assertKeyEquals(String message, _KeyType_ expected, _KeyType_ actual) {
    ...
    public void testSimplePut() {
        ...
        assertKeyEquals("Map keys should contain new value", 
                        Types.get_KeyName_For(100), 
                        (_KeyType_)m_map.getKeys()[0]);
        assertValueEquals("Map values should contain new value",
                          Types.get_ValueName_For(200), 
                          (_ValueType_)m_map.getValues()[0]);
    }
